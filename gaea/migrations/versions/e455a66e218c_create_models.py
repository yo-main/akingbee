...
def upgrade():
    ...
    op.create_table('apiary_statuses',
    sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('name', sa.TEXT(), nullable=True),
    sa.Column('user_id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(), nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_apiary_statuses_user_id_users')),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_event_statuses_user_id_users')),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_event_types_user_id_users')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_event_types'))
    )
    op.create_table('hive_conditions',
    sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('name', sa.TEXT(), nullable=False),
    sa.Column('user_id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(), nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_hive_conditions_user_id_users')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_hive_conditions'))
    )
    op.create_table('honey_types',
    sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('name', sa.TEXT(), nullable=True),
    sa.Column('user_id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(), nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_honey_types_user_id_users')),
    ...
    op.create_table('swarm_health_statuses',
    sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('name', sa.TEXT(), nullable=True),
    sa.Column('user_id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(), nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_swarm_health_statuses_user_id_users')),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(), nullable=True),
    sa.ForeignKeyConstraint(['honey_type_id'], ['honey_types.id'], name=op.f('fk_apiaries_honey_type_id_honey_types')),
    sa.ForeignKeyConstraint(['status_id'], ['apiary_statuses.id'], name=op.f('fk_apiaries_status_id_apiary_statuses')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_apiaries_user_id_users')),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(), nullable=True),
    sa.ForeignKeyConstraint(['health_status_id'], ['swarm_health_statuses.id'], name=op.f('fk_swarms_health_status_id_swarm_health_statuses')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_swarms_user_id_users')),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(), nullable=True),
    sa.ForeignKeyConstraint(['apiary_id'], ['apiaries.id'], name=op.f('fk_hives_apiary_id_apiaries')),
    sa.ForeignKeyConstraint(['condition_id'], ['hive_conditions.id'], name=op.f('fk_hives_condition_id_hive_conditions')),
    sa.ForeignKeyConstraint(['owner_id'], ['owners.id'], name=op.f('fk_hives_owner_id_owners')),
    sa.ForeignKeyConstraint(['swarm_id'], ['swarms.id'], name=op.f('fk_hives_swarm_id_swarms')),
