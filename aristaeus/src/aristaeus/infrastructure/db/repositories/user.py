...
from aristaeus.infrastructure.db.models.user import user_table
...
class UserRespository:
    ...
    @error_handler
    async def get(self, public_id: UUID) -> UserEntity:
        query = select(UserEntity).where(user_table.c.public_id == public_id)
    ...
    async def save(self, user: UserEntity) -> None:
        ...
        query = insert(user_table).values(data).on_conflict_do_nothing()
